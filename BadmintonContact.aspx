...
<asp:Content ID="Content1" ContentPlaceHolderID="ph_Centre" Runat="Server">
    ...
    <p>Email : <rbgp:EmailLink ID="emailId" runat="server" NavigateUrl="mailto:angelcentre.badders.club@hotmail.co.uk">angelcentre.badders.club@hotmail.co.uk</rbgp:EmailLink></p>
    <p>Angel Centre, Angel Lane, Tonbridge,Kent TN9 1SF
        <span>
